...
url="https://www.snapdeal.com/product/dell-inspiron-3558-w5661107th-notebook/677536208746/reviews?page=2&sortBy=RECENCY#defRevPDP"
response = requests.get(url)
soup = bs(response.content,"html.parser")# creating soup object to iterate over the extracted content
# print (soup.prettify())

#scrapping review content
review= soup.find_all("p",class_=False, id=False)
# print(name) 
review_content=[]
...
print (df.head())
# df.to_csv(r'D:/Data Science Course/Assignments/Text Mining/Snapdeal_Reviews.csv', index=True)
